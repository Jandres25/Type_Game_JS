...
function spawnEnemiesGradually(level) {
  let numNormalEnemies = 0 + level / level; // Aumenta la cantidad de enemigos normales con cada nivel
  let numBlueEnemies = 1 + Math.floor(level / 2); // Aumenta la cantidad de enemigos azules cada dos niveles
